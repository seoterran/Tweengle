  ...
  exports.BuddyList = Backbone.Collection.extend({
    ...
    addRemoteUser: function(connection) {
      ...
      log.info('BuddyList: addRemoteUser', newUser);
       // newUser.chattingModalView.set('remoteUser',newUser);
      this.push(newUser);
    },
    ...
    removeRemoteUser: function(connection) {
      ...
      removingUser.updateStatus('offline');//need to change so that it is executed only when offlineList does not include it. 
